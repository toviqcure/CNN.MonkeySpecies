...
trainMyImagesFolder = "/Users/admin/Documents/Udemy/CNN/Monkey-Species/archive/training/training"
testMyImagesFolder = "/Users/admin/Documents/Udemy/CNN/Monkey-Species/archive/validation/validation"
...
stepsPerEpochs = int(np.ceil(training_set.samples / batchSize))  # Convert to integer
validationSteps = int(np.ceil(test_set.samples / batchSize))  # Convert to integer

best_model_file = "/Users/admin/Documents/Udemy/CNN/Monkey-Species/myCnnMonkeyModel.keras"
...
history = model.fit (
    ...
    #steps_per_epoch=math.ceil(training_set), # // batchSize),
    validation_steps = validationSteps,
    #validation_steps=math.ceil(validationSteps), #// batchSize),
    verbose=1,
    callbacks=[bestModel])
